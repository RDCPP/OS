# 1 "tracer.c"
# 1 "/home/rdcpp/Desktop/OS/OS/8th/process_hacking//"
# 1 "<built-in>"
# 1 "<command-line>"
# 31 "<command-line>"
...
# 23 "/usr/include/x86_64-linux-gnu/sys/ptrace.h" 3 4
...
# 78 "/usr/include/x86_64-linux-gnu/bits/ptrace-shared.h" 3 4
extern long int ptrace (enum __ptrace_request __request, ...) __attribute__ ((__nothrow__ , __leaf__));
# 191 "/usr/include/x86_64-linux-gnu/sys/ptrace.h" 2 3 4
...
void print_peek_data(pid_t tracee_pid, long long int byte_offset) {
  ...
  peek_output = ptrace(PTRACE_PEEKDATA, tracee_pid, byte_offset, 
# 16 "util.c" 3 4
                                                                ((void *)0)
# 16 "util.c"
                                                                    );
...
_Bool 
# 81 "util.c"
    peekpoke_interactively(pid_t tracee_pid ,struct user_regs_struct regs) {
...
# 28 "tracer.c"
    ...
    ptrace(PTRACE_SINGLESTEP, tracee_pid, 
# 29 "tracer.c" 3 4
                                         ((void *)0)
# 29 "tracer.c"
                                             , 
...
# 29 "tracer.c"
    ...
    waitpid(tracee_pid, &status, 0);
    ptrace(PTRACE_GETREGS, tracee_pid, 
# 31 "tracer.c" 3 4
                                      ((void *)0)
# 31 "tracer.c"
                                          , &regs);
  ...
  ptrace(PTRACE_DETACH, tracee_pid, 
# 36 "tracer.c" 3 4
                                   ((void *)0)
# 36 "tracer.c"
                                       , 
